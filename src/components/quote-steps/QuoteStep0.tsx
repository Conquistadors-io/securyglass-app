        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <RadioGroup value={formData.serviceType} onValueChange={handleServiceTypeChange} className="space-y-4">
              <label htmlFor="vitrerie" className={`flex items-center space-x-3 p-4 border-2 rounded-lg hover:bg-accent/50 transition-colors cursor-pointer ${formData.serviceType === 'vitrerie' ? 'border-primary bg-primary/5' : 'border-border'}`}>
              ...
              <label htmlFor="miroiterie" className={`flex items-center space-x-3 p-4 border-2 rounded-lg hover:bg-accent/50 transition-colors cursor-pointer ${formData.serviceType === 'miroiterie' ? 'border-primary bg-primary/5' : 'border-border'}`}>
              ...
              <div className="space-y-2">
                <div className={`flex items-center space-x-3 p-4 border-2 rounded-lg hover:bg-accent/50 transition-colors ${formData.serviceType === 'autres' ? 'border-primary bg-primary/5' : 'border-border'}`}>
                ...
                {showAutresOptions && <div className="ml-6 space-y-2">
                    <label htmlFor="renovation" className={`flex items-center space-x-3 p-3 border-2 rounded-lg hover:bg-accent/50 transition-colors cursor-pointer ${formData.serviceType === 'renovation' ? 'border-primary bg-primary/5' : 'border-border'}`}>
                      <RadioGroupItem value="renovation" id="renovation" className="w-5 h-5" />
                      <div className="flex-1 text-foreground">Rénovation</div>
                    </label>
                  </div>}
              </div>
            </RadioGroup>
