...
import { Camera, Ruler, Shield } from "lucide-react";
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <Input
                  ...
                  onChange={(e) => setFormData(prev => ({...prev, largeur: e.target.value}))}
                  required
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <Input
                  ...
                  onChange={(e) => setFormData(prev => ({...prev, hauteur: e.target.value}))}
                  required
                />
              </div>
            </div>
          ...
          <div>
            ...
            <Select 
              ...
              onValueChange={(value) => setFormData(prev => ({...prev, assurance: value}))}
            >
              <SelectTrigger className="mt-1">
