      ...
      <div className="p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="mt-1">
              <Input id="codePostal" value={formData.codePostal} onChange={e => setFormData(prev => ({
              ...prev,
          ...
          <div>
            ...
            <div className="mt-1">
              <CitySelect value={formData.ville} onValueChange={value => setFormData(prev => ({
              ...prev,
              ville: value
            }))} postalCode={formData.codePostal} placeholder="Sélectionnez une ville" />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-1">
              <AddressSelect value={formData.adresse} onValueChange={value => setFormData(prev => ({
              ...prev,
              adresse: value
            }))} departmentCode={formData.codePostal} city={formData.ville} placeholder="Tapez votre adresse" />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-1">
              <InsuranceSelect value={formData.assurance} onValueChange={value => setFormData(prev => ({
              ...prev,
              assurance: value
