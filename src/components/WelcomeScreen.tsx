    ...
    <div className="min-h-screen bg-gradient-hero flex flex-col">
      ...
      <div className="flex-1 px-6 py-8">
        <div className="max-w-md mx-auto space-y-6">
          ...
          {/* Client Card */}
          <Card 
            className="p-6 cursor-pointer transition-all duration-300 hover:scale-105 bg-white/95 backdrop-blur shadow-card border-0"
          ...
          <Card 
            className="p-6 cursor-pointer transition-all duration-300 hover:scale-105 bg-white/95 backdrop-blur shadow-card border-0"
            onClick={() => setSelectedUserType('technician')}
          >
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-foreground">Technicien</h3>
                <p className="text-sm text-muted-foreground">
          ...
          {selectedUserType === 'client' && (
            <div className="space-y-4 mt-8 animate-scale-in">
              <Button 
                ...
                size="lg" 
                className="w-full"
                onClick={() => onNavigate('urgent-intervention')}
              >
